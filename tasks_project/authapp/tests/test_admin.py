...
class AdminUserFormTest(APITestCase):
    def setUp(self):
        ...
        self.client.login(username='admin', password='adminpass')  # логинюсь не вообще, а в админку!
    ...
    def test_user_change_form_group_selection(self):
        ...
        self.assertIn(f'<option value="{self.group1.pk}" selected>', response.content.decode())
