...
urlpatterns = [
    ...
    path('confirm_register/', ConfirmRegisterAPIView.as_view(), name='confirm_register'),
    path('repeat_confirm_register', RepeatConfirmRegisterAPIView.as_view(), name='repeat_confirm_register'),
    ...
    path('password_change/<uid>/<token>/', ChangePasswordAPIView.as_view(), name="change_password"),
