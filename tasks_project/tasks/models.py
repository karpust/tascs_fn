...
class Task(models.Model):
    ...
    status = models.IntegerField(choices=TaskStatus.choices, default=TaskStatus.TO_DO, verbose_name="Статус выполнения")
    deadline = models.DateTimeField(default=default_deadline, verbose_name="Срок выполнения")
    priority = models.IntegerField(choices=TaskPriority.choices, default=TaskPriority.LOW, verbose_name="Приоритет задачи")
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='task_owner', verbose_name="Создатель задачи")
